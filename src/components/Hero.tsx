...
export function Hero() {
  return (
    <section className="relative min-h-screen bg-maroon-radial overflow-hidden pt-16 pb-24">
      ...
      <div className="relative max-w-5xl mx-auto px-6 text-center z-10 animate-rise">
        <div className="font-tamil text-gold/90 text-base md:text-lg tracking-[0.2em] mb-4">
          ॥ ஶுபமஸ்து ॥
        </div>

        <OrnamentDivider label="Gruhapravesam" />
        ...
        {/* Muhurtham card */}
        <div className="glass-gold rounded-2xl px-8 py-8 max-w-2xl mx-auto shadow-elegant mb-12">
        ...
        <Countdown target={CEREMONY_DATE} />
      </div>
    </section>
  );
}
